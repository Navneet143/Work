...
public class Temperature {
	...
	public Temperature(WebDriver driver ,Xpath xpath) {
		this.xpath=xpath;
		this.driver = driver;
	}
	
	public void set_SelectedCites() {
		List<WebElement> inputs = driver.findElements(By.xpath(xpath.getlistofcities()));
	...
	public void PrintTemp(String city) {
		...
		List<WebElement> Temp = driver
				.findElements(By.xpath(String.format(xpath.gettemperature(), city)));// Xpath-//div[@title="Mumbai"]//span[@class]
